...
impl DataBlock {
    ...
    pub fn create_byte_data_block(agent: Context<'_, '_, '_>, size: u64) -> JsResult<Self> {
    ...
    pub fn create_shared_byte_data_block(agent: Context<'_, '_, '_>, size: u64) -> JsResult<Self> {
